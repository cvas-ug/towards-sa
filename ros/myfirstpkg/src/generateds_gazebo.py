...
#        print(type(x))
        ...
        with open("./dataset/pro/pro{}_{}.txt".format(counter, proprioseption.header.stamp.secs), 'wb') as intofile:
...
#        print(type(x))
        ...
        cv2.imwrite("./dataset/images/image{}_{}.jpg".format(counter, image.header.stamp.secs), cv_image)
